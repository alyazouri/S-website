      ...
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-white/60">{t("pac_sub", lang)}</p>
          </div>
        ...
        {enabled ? (
          ...
          <div className="mt-6 rounded-2xl border border-white/5 bg-black/30 p-8 text-center">
            ...
            <div className="mt-1 text-sm text-white/50">{t("pac_disabled_msg", lang)}</div>
            <button onClick={() => setEnabled(true)} className="btn-primary mt-5 rounded-xl px-6 py-3 text-sm">
