...
import { BRANDS, WEAPONS } from "@/lib/data";
  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a14] shadow-2xl">
